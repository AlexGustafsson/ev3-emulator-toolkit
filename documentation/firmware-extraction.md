...
└── cramfs-root
    ...
    │   ├── hostname -> busybox
    │   ├── ip -> /sbin/ip.iproute2
    │   ├── kill -> kill.util-linux-ng
    │   ├── kill.util-linux-ng
    │   ├── ln -> busybox
    │   ├── login -> login.util-linux-ng
    │   ├── login.util-linux-ng
    │   ├── ls -> busybox
    │   ├── lsmod -> /bin/lsmod.26
    │   ├── lsmod.26
    ...
    │   ├── mknod -> busybox
    │   ├── mktemp -> busybox
    │   ├── more -> more.util-linux-ng
    │   ├── more.util-linux-ng
    │   ├── mount -> mount.util-linux-ng
    │   ├── mount.util-linux-ng
    │   ├── mountpoint -> mountpoint.sysvinit
    │   ├── mountpoint.sysvinit
    │   ├── mv -> busybox
    │   ├── netstat -> busybox
    │   ├── nice -> busybox
    │   ├── pidof -> pidof.sysvinit
    │   ├── pidof.sysvinit -> ../sbin/killall5
    │   ├── ping -> busybox
    │   ├── ping6 -> busybox
    │   ├── ps -> busybox
    │   ├── pwd -> busybox
...
* The roughly 16MB `.srec` file seems to be the main archive (based on that its size is equal to that of the firwmare file itself).
* The `.cramfs` files are the root image, which is available in the `cramfs-root` directory.
* The `5540F` is another archive file which is extracted in `_5540F.extracted`
* The `1DEAF` file seems to be the compiled Linux kernel
* The `2DEB54` file is the Linux kernel make config

```
# Automatically generated make config: don't edit
# Linux kernel version: 2.6.33-rc4
# Mon Mar  5 11:25:01 2018
CONFIG_ARM=y
...
CONFIG_EXTRA_FIRMWARE="PRU_SUART_Emulation.bin"
CONFIG_EXTRA_FIRMWARE_DIR="pru-firmware-05-31-2011-1423-v3.0"
...
CONFIG_OMAPL_SUART_FW_SOURCE="../../../pru-firmware-05-31-2011-1423-v3.0/pru"
